...
- AI 服务: 七牛 AI Token API (DeepSeek-V3, Gemini 2.5 Flash, TTS)
...
# 七牛 AI Token API
QINIU_API_KEY=sk-...  # 用于文本分析(DeepSeek-V3)、图像生成(七牛文生图 API)、TTS(语音合成)
...
- [七牛 AI Token API TTS 文档](https://developer.qiniu.com/aitokenapi/12981/asr-tts-ocr-api)
